# DATA PATHS
EVENT_LINK_FILE = 'postgres/event_links.txt'
LABEL_LINK_FILE = 'postgres/label_links.txt'
...
OPENFDA_COLS =      ['drugid', 'spl_id_primary', 'application_number', 'brand_name', 'generic_name', 'manufacturer_name', 'product_ndc', 'product_type', 'administration_route', 'substance_name', 'rxcui', 'spl_id', 'spl_set_id', 'package_ndc', 'nui', 'pharm_class_epc', 'pharm_class_moa', 'unii']
...
PATIENT_COLS =      ['patientonsetage', 'patientsex', 'patientweight', 'patientagegroup'] 
...
DRUGREPORT_COLS =   ['safetyreportid', 'spl_id_primary', 'drugcharacterization']
