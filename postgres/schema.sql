CREATE SCHEMA IF NOT EXISTS openfda;
...
CREATE TABLE openfda.drug_interactions (
    id SERIAL PRIMARY KEY,
    drug1_id TEXT REFERENCES openfda.drugs(drugid),
    drug2_id TEXT REFERENCES openfda.drugs(drugid),
    ...
    created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT check_drug_order CHECK (drug1_id < drug2_id)
);
